...
This page about the integration of the PrestaShop Account and Billing components using VueJS is deprecated. A new procedure is now available to integrate [PrestaShop Account](../4-prestashop-account/README.md) and [PrestaShop Billing](../5-prestashop-billing/1-overview/README.md) with vanilla JavaScript.
:::
